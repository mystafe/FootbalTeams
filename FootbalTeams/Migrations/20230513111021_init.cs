        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GoalkeepingPower = table.Column<double>(type: "float", nullable: true),
                    DefencePower = table.Column<double>(type: "float", nullable: true),
                    MiddlefieldPower = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlayerPosition = table.Column<int>(type: "int", nullable: true),
                    GoalkeepingPower = table.Column<double>(type: "float", nullable: true),
                    DefencePower = table.Column<double>(type: "float", nullable: true),
                    AttackPower = table.Column<double>(type: "float", nullable: true),
